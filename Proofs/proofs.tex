...
\begin{theorem}
  The solutions of a quadratic equation of the form \(ax^{2} + bx + c = 0\) can
...
\begin{proof}
  Completing the square on the general quadratic equation \(ax^{2} + bx + c =
  0\) gives
...
\begin{theorem}
  A logarithm of the form \(\log_{b}(xy)\) can be expressed as \(\log_{b}(x) +
  \log_{b}(y)\).
\end{theorem}
...
\begin{theorem}
  A logarithm of the form \(\log_{b}(\frac{x}{y})\) can be expressed as
  \(\log_{b}(x) - \log_{b}(y)\).
\end{theorem}
...
\begin{theorem}
  Any logarithm \(\log_{b}(a)\) can be re-expressed in terms of another base
  with the formula
